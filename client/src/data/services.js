...
export const SERVICES = [
  {
    ...
    includes: [
      ...
      'Break room, kitchen, refrigerator, and appliance cleaning',
      'Trash, recycling, and compost removal with liner replacement',
      'Interior glass, partitions, entry doors, and reception detail',
    ...
    industries: [
      ...
      'Law, accounting, and professional firms',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes. The majority of our {city} commercial and office accounts are cleaned after hours — evenings, overnight, or early morning — so your team walks into a finished space and never works around a cleaning crew. Weekend and holiday coverage is available at no premium on most contracts.',
      },
      {
      ...
      {
        q: 'Can you clean during a hybrid or partial-occupancy schedule?',
        a: 'Yes, and it is one of the more common requests we get in {city}. We align cleaning frequency to your actual occupancy days — deep service on the nights your office is full, lighter maintenance on low-occupancy days. It usually reduces cost without reducing cleanliness.',
      },
      {
